...
Game state is managed server-side using FastAPI sessions. Each player gets a unique session ID stored in cookies, with game data persisted in memory via `GameSession` instances.
